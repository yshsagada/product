...
@Component
public class CategoryLowestPriceDeleteStrategy implements CategoryLowestPriceRedisStrategy {
    ...
    {
        log.info("CategoryLowestPriceDeleteStrategy handle : {}", productEvent);
